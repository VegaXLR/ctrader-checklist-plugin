...
__export(api_exports, {
  SdkInterfaces: () => sdkInterfaces_exports,
  ServerInterfaces: () => serverInterfaces_exports,
  ...
  getAccountGroupInformation: () => getAccountGroupInformation,
  getAccountGroupInformationHandler: () => getAccountGroupInformationHandler,
  getAccountInformation: () => getAccountInformation,
  getAccountInformationHandler: () => getAccountInformationHandler,
  getDealList: () => getDealList,
  getDealListHandler: () => getDealListHandler,
  getDynamicLeverage: () => getDynamicLeverage,
  getDynamicLeverageHandler: () => getDynamicLeverageHandler,
  getLightSymbolList: () => getLightSymbolList,
  getLightSymbolListHandler: () => getLightSymbolListHandler,
  getServerData: () => getServerData,
  getServerDataHandler: () => getServerDataHandler,
  getSymbol: () => getSymbol,
  getSymbolHandler: () => getSymbolHandler,
  getTrendbarList: () => getTrendbarList,
  getTrendbarListHandler: () => getTrendbarListHandler,
  handleConfirmEvent: () => handleConfirmEvent,
  handleExecutionEvent: () => handleExecutionEvent,
  handleQuoteEvent: () => handleQuoteEvent,
  handleRegisterEvent: () => handleRegisterEvent,
  handleServerDataEvent: () => handleServerDataEvent,
  modifyOrder: () => modifyOrder2,
  modifyOrderHandler: () => modifyOrderHandler,
  modifyOrderProtection: () => modifyOrderProtection2,
  modifyOrderProtectionHandler: () => modifyOrderProtectionHandler,
  openInternalUrl: () => openInternalUrl,
  openInternalUrlHandler: () => openInternalUrlHandler,
  quoteEvent: () => quoteEvent,
  registerEvent: () => registerEvent,
  serverDataEvent: () => serverDataEvent,
  subscribeQuotes: () => subscribeQuotes,
  subscribeQuotesHandler: () => subscribeQuotesHandler,
  unsubscribeQuotes: () => unsubscribeQuotes,
  unsubscribeQuotesHandler: () => unsubscribeQuotesHandler
});
module.exports = __toCommonJS(api_exports);

// api/generated/sdkInterfaces.ts
var sdkInterfaces_exports = {};
__export(sdkInterfaces_exports, {
  PublicMessagePayloadType: () => PublicMessagePayloadType
});
var PublicMessagePayloadType = /* @__PURE__ */ ((PublicMessagePayloadType2) => {
  PublicMessagePayloadType2[PublicMessagePayloadType2["RegisterEvent"] = 2e3] = "RegisterEvent";
  PublicMessagePayloadType2[PublicMessagePayloadType2["ConfirmEvent"] = 2001] = "ConfirmEvent";
  PublicMessagePayloadType2[PublicMessagePayloadType2["GetServerDataReq"] = 2100] = "GetServerDataReq";
  PublicMessagePayloadType2[PublicMessagePayloadType2["GetServerDataRes"] = 2101] = "GetServerDataRes";
  PublicMessagePayloadType2[PublicMessagePayloadType2["ServerDataEvent"] = 2102] = "ServerDataEvent";
  PublicMessagePayloadType2[PublicMessagePayloadType2["OpenInternalUrlReq"] = 2103] = "OpenInternalUrlReq";
  PublicMessagePayloadType2[PublicMessagePayloadType2["OpenInternalUrlRes"] = 2104] = "OpenInternalUrlRes";
  PublicMessagePayloadType2[PublicMessagePayloadType2["PublicErrorRes"] = 2500] = "PublicErrorRes";
  return PublicMessagePayloadType2;
})(PublicMessagePayloadType || {});

// api/generated/sdkFunctions.ts
var import_uuid = require("uuid");
var import_rxjs = __toESM(require_cjs());
var import_operators = __toESM(require_operators());
var publicErrorRes = (payload, clientMsgId) => {
  return {
    payloadType: 2500 /* PublicErrorRes */,
    payload,
    clientMsgId
  };
};
var getServerData = (transport, payload, multiple = false) => {
  const observer = transport.send({
    payloadType: 2100 /* GetServerDataReq */,
    payload,
    clientMsgId: (0, import_uuid.v4)()
  });
  if (!multiple) {
    return observer.pipe((0, import_rxjs.take)(1));
  }
  return observer;
};
var getServerDataHandler = (transport, handler) => {
  return transport.event$.pipe(
    (0, import_rxjs.filter)((message) => message.payloadType === 2100 /* GetServerDataReq */),
    (0, import_operators.mergeMap)((message) => {
      try {
        ...
        return data$.pipe(
          (0, import_operators.mergeMap)((response) => {
            return transport.send(getServerDataRes(response, message.clientMsgId), { completed: true }).pipe(
              (0, import_rxjs.map)(() => ({ request: payload, response, hostId: message.hostId }))
            );
          })
        );
      } catch (error) {
        return transport.send(publicErrorRes({}, message.clientMsgId)).pipe(
          (0, import_operators.mergeMap)(() => import_rxjs.EMPTY)
        );
      }
    })
  );
};
var getServerDataRes = (payload, clientMsgId) => {
  return {
    payloadType: 2101 /* GetServerDataRes */,
    payload,
    clientMsgId
  };
};
var openInternalUrl = (transport, payload, multiple = false) => {
  const observer = transport.send({
    payloadType: 2103 /* OpenInternalUrlReq */,
    payload,
    clientMsgId: (0, import_uuid.v4)()
  });
  if (!multiple) {
...
var openInternalUrlHandler = (transport, handler) => {
  return transport.event$.pipe(
    (0, import_rxjs.filter)((message) => message.payloadType === 2103 /* OpenInternalUrlReq */),
    (0, import_operators.mergeMap)((message) => {
      try {
        const payload = message.payload;
        const data$ = handler(payload, {
        ...
        return data$.pipe(
          (0, import_operators.mergeMap)((response) => {
            return transport.send(openInternalUrlRes(response, message.clientMsgId), { completed: true }).pipe(
              (0, import_rxjs.map)(() => ({ request: payload, response, hostId: message.hostId }))
            );
          })
        );
...
var openInternalUrlRes = (payload, clientMsgId) => {
  return {
    payloadType: 2104 /* OpenInternalUrlRes */,
    payload,
    clientMsgId
  };
};
var registerEvent = (transport) => {
  return transport.event$.pipe(
    (0, import_rxjs.filter)((message) => message.payloadType === 2e3 /* RegisterEvent */),
    (0, import_rxjs.map)((message) => message.payload)
  );
};
var handleRegisterEvent = (transport, payload) => {
  return transport.send(registerEventData(payload, (0, import_uuid.v4)()), { completed: true }).pipe(
    (0, import_operators.mergeMap)(() => {
      return [];
    })
  );
};
var registerEventData = (payload, clientMsgId) => {
  return {
    payloadType: 2e3 /* RegisterEvent */,
    payload,
    clientMsgId
  };
};
var confirmEvent = (transport) => {
  return transport.event$.pipe(
    (0, import_rxjs.filter)((message) => message.payloadType === 2001 /* ConfirmEvent */),
    (0, import_rxjs.map)((message) => message.payload)
  );
};
var handleConfirmEvent = (transport, payload) => {
  return transport.send(confirmEventData(payload, (0, import_uuid.v4)()), { completed: true }).pipe(
    (0, import_operators.mergeMap)(() => {
      return [];
    })
  );
};
var confirmEventData = (payload, clientMsgId) => {
  return {
    payloadType: 2001 /* ConfirmEvent */,
    payload,
    clientMsgId
  };
};
var serverDataEvent = (transport) => {
  return transport.event$.pipe(
    (0, import_rxjs.filter)((message) => message.payloadType === 2102 /* ServerDataEvent */),
    (0, import_rxjs.map)((message) => message.payload)
  );
};
var handleServerDataEvent = (transport, payload) => {
  return transport.send(serverDataEventData(payload, (0, import_uuid.v4)()), { completed: true }).pipe(
    (0, import_operators.mergeMap)(() => {
      return [];
    })
  );
};
var serverDataEventData = (payload, clientMsgId) => {
  return {
    payloadType: 2102 /* ServerDataEvent */,
    payload,
    clientMsgId
  };
};

// api/generated/serverInterfaces.ts
var serverInterfaces_exports = {};
__export(serverInterfaces_exports, {
  ProtoAccessRights: () => ProtoAccessRights,
  ProtoAccountLifetimeType: () => ProtoAccountLifetimeType,
  ProtoAccountType: () => ProtoAccountType,
  ProtoBookType: () => ProtoBookType,
  ProtoChangeBalanceType: () => ProtoChangeBalanceType,
  ProtoChangeBonusType: () => ProtoChangeBonusType,
  ProtoCommissionType: () => ProtoCommissionType,
  ProtoDayOfWeek: () => ProtoDayOfWeek,
  ProtoDealStatus: () => ProtoDealStatus,
  ProtoDealType: () => ProtoDealType,
  ProtoExecutionType: () => ProtoExecutionType,
  ProtoLimitedRiskMarginCalculationStrategy: () => ProtoLimitedRiskMarginCalculationStrategy,
  ProtoMinCommissionType: () => ProtoMinCommissionType,
  ProtoOrderStatus: () => ProtoOrderStatus,
  ProtoOrderTriggerMethod: () => ProtoOrderTriggerMethod,
  ProtoOrderType: () => ProtoOrderType,
  ProtoPositionStatus: () => ProtoPositionStatus,
  ProtoPublicServerPayloadType: () => ProtoPublicServerPayloadType,
  ProtoStopOutStrategy: () => ProtoStopOutStrategy,
  ProtoSwapCalculationType: () => ProtoSwapCalculationType,
  ProtoSymbolDistanceType: () => ProtoSymbolDistanceType,
  ProtoTickbarPeriod: () => ProtoTickbarPeriod,
  ProtoTimeInForce: () => ProtoTimeInForce,
  ProtoTimeframe: () => ProtoTimeframe,
  ProtoTotalMarginCalculationType: () => ProtoTotalMarginCalculationType,
  ProtoTradeSide: () => ProtoTradeSide,
  ProtoTradingMode: () => ProtoTradingMode,
  ProtoTrendbarPeriod: () => ProtoTrendbarPeriod,
  ProtoTrendbarType: () => ProtoTrendbarType
});
var ProtoAccountType = /* @__PURE__ */ ((ProtoAccountType2) => {
  ProtoAccountType2[ProtoAccountType2["HEDGED"] = 0] = "HEDGED";
  ProtoAccountType2[ProtoAccountType2["NETTED"] = 1] = "NETTED";
  ProtoAccountType2[ProtoAccountType2["SPREAD_BETTING"] = 2] = "SPREAD_BETTING";
  return ProtoAccountType2;
})(ProtoAccountType || {});
var ProtoCommissionType = /* @__PURE__ */ ((ProtoCommissionType2) => {
  ProtoCommissionType2[ProtoCommissionType2["USD_PER_MILLION_USD"] = 1] = "USD_PER_MILLION_USD";
  ProtoCommissionType2[ProtoCommissionType2["USD_PER_LOT"] = 2] = "USD_PER_LOT";
  ProtoCommissionType2[ProtoCommissionType2["PERCENTAGE_OF_VALUE"] = 3] = "PERCENTAGE_OF_VALUE";
  ProtoCommissionType2[ProtoCommissionType2["QUOTE_CCY_PER_LOT"] = 4] = "QUOTE_CCY_PER_LOT";
  return ProtoCommissionType2;
})(ProtoCommissionType || {});
var ProtoAccessRights = /* @__PURE__ */ ((ProtoAccessRights2) => {
  ProtoAccessRights2[ProtoAccessRights2["FULL_ACCESS"] = 0] = "FULL_ACCESS";
  ProtoAccessRights2[ProtoAccessRights2["CLOSE_ONLY"] = 1] = "CLOSE_ONLY";
  ProtoAccessRights2[ProtoAccessRights2["NO_TRADING"] = 2] = "NO_TRADING";
  ProtoAccessRights2[ProtoAccessRights2["NO_LOGIN"] = 3] = "NO_LOGIN";
  return ProtoAccessRights2;
})(ProtoAccessRights || {});
var ProtoTotalMarginCalculationType = /* @__PURE__ */ ((ProtoTotalMarginCalculationType2) => {
  ProtoTotalMarginCalculationType2[ProtoTotalMarginCalculationType2["MAX"] = 0] = "MAX";
  ProtoTotalMarginCalculationType2[ProtoTotalMarginCalculationType2["SUM"] = 1] = "SUM";
  ProtoTotalMarginCalculationType2[ProtoTotalMarginCalculationType2["NET"] = 2] = "NET";
  return ProtoTotalMarginCalculationType2;
})(ProtoTotalMarginCalculationType || {});
var ProtoLimitedRiskMarginCalculationStrategy = /* @__PURE__ */ ((ProtoLimitedRiskMarginCalculationStrategy2) => {
  ProtoLimitedRiskMarginCalculationStrategy2[ProtoLimitedRiskMarginCalculationStrategy2["ACCORDING_TO_LEVERAGE"] = 0] = "ACCORDING_TO_LEVERAGE";
  ProtoLimitedRiskMarginCalculationStrategy2[ProtoLimitedRiskMarginCalculationStrategy2["ACCORDING_TO_GSL"] = 1] = "ACCORDING_TO_GSL";
  ProtoLimitedRiskMarginCalculationStrategy2[ProtoLimitedRiskMarginCalculationStrategy2["ACCORDING_TO_GSL_AND_LEVERAGE"] = 2] = "ACCORDING_TO_GSL_AND_LEVERAGE";
  return ProtoLimitedRiskMarginCalculationStrategy2;
})(ProtoLimitedRiskMarginCalculationStrategy || {});
var ProtoStopOutStrategy = /* @__PURE__ */ ((ProtoStopOutStrategy2) => {
  ProtoStopOutStrategy2[ProtoStopOutStrategy2["MOST_MARGIN_USED_FIRST"] = 0] = "MOST_MARGIN_USED_FIRST";
  ProtoStopOutStrategy2[ProtoStopOutStrategy2["MOST_LOSING_FIRST"] = 1] = "MOST_LOSING_FIRST";
  return ProtoStopOutStrategy2;
})(ProtoStopOutStrategy || {});
var ProtoAccountLifetimeType = /* @__PURE__ */ ((ProtoAccountLifetimeType2) => {
  ProtoAccountLifetimeType2[ProtoAccountLifetimeType2["UNLIMITED"] = 1] = "UNLIMITED";
  ProtoAccountLifetimeType2[ProtoAccountLifetimeType2["LIMITED_INACTIVITY"] = 2] = "LIMITED_INACTIVITY";
  ProtoAccountLifetimeType2[ProtoAccountLifetimeType2["LIMITED_CREATION"] = 3] = "LIMITED_CREATION";
  ProtoAccountLifetimeType2[ProtoAccountLifetimeType2["LIMITED_CREATION_FREE"] = 4] = "LIMITED_CREATION_FREE";
  return ProtoAccountLifetimeType2;
})(ProtoAccountLifetimeType || {});
var ProtoDayOfWeek = /* @__PURE__ */ ((ProtoDayOfWeek2) => {
  ProtoDayOfWeek2[ProtoDayOfWeek2["NONE"] = 0] = "NONE";
  ProtoDayOfWeek2[ProtoDayOfWeek2["MONDAY"] = 1] = "MONDAY";
  ProtoDayOfWeek2[ProtoDayOfWeek2["TUESDAY"] = 2] = "TUESDAY";
  ProtoDayOfWeek2[ProtoDayOfWeek2["WEDNESDAY"] = 3] = "WEDNESDAY";
  ProtoDayOfWeek2[ProtoDayOfWeek2["THURSDAY"] = 4] = "THURSDAY";
  ProtoDayOfWeek2[ProtoDayOfWeek2["FRIDAY"] = 5] = "FRIDAY";
  ProtoDayOfWeek2[ProtoDayOfWeek2["SATURDAY"] = 6] = "SATURDAY";
  ProtoDayOfWeek2[ProtoDayOfWeek2["SUNDAY"] = 7] = "SUNDAY";
  return ProtoDayOfWeek2;
})(ProtoDayOfWeek || {});
var ProtoMinCommissionType = /* @__PURE__ */ ((ProtoMinCommissionType2) => {
  ProtoMinCommissionType2[ProtoMinCommissionType2["CURRENCY"] = 1] = "CURRENCY";
  ProtoMinCommissionType2[ProtoMinCommissionType2["QUOTE_CURRENCY"] = 2] = "QUOTE_CURRENCY";
  return ProtoMinCommissionType2;
})(ProtoMinCommissionType || {});
var ProtoTradingMode = /* @__PURE__ */ ((ProtoTradingMode2) => {
  ProtoTradingMode2[ProtoTradingMode2["ENABLED"] = 0] = "ENABLED";
  ProtoTradingMode2[ProtoTradingMode2["DISABLED_WITHOUT_PENDINGS_EXECUTION"] = 1] = "DISABLED_WITHOUT_PENDINGS_EXECUTION";
  ProtoTradingMode2[ProtoTradingMode2["DISABLED_WITH_PENDINGS_EXECUTION"] = 2] = "DISABLED_WITH_PENDINGS_EXECUTION";
  ProtoTradingMode2[ProtoTradingMode2["CLOSE_ONLY_MODE"] = 3] = "CLOSE_ONLY_MODE";
  return ProtoTradingMode2;
})(ProtoTradingMode || {});
var ProtoSymbolDistanceType = /* @__PURE__ */ ((ProtoSymbolDistanceType2) => {
  ProtoSymbolDistanceType2[ProtoSymbolDistanceType2["SYMBOL_DISTANCE_IN_POINTS"] = 1] = "SYMBOL_DISTANCE_IN_POINTS";
  ProtoSymbolDistanceType2[ProtoSymbolDistanceType2["SYMBOL_DISTANCE_IN_PERCENTAGE"] = 2] = "SYMBOL_DISTANCE_IN_PERCENTAGE";
  return ProtoSymbolDistanceType2;
})(ProtoSymbolDistanceType || {});
var ProtoSwapCalculationType = /* @__PURE__ */ ((ProtoSwapCalculationType2) => {
  ProtoSwapCalculationType2[ProtoSwapCalculationType2["PIPS"] = 0] = "PIPS";
  ProtoSwapCalculationType2[ProtoSwapCalculationType2["PERCENTAGE"] = 1] = "PERCENTAGE";
  ProtoSwapCalculationType2[ProtoSwapCalculationType2["POINTS"] = 2] = "POINTS";
  return ProtoSwapCalculationType2;
})(ProtoSwapCalculationType || {});
var ProtoDealStatus = /* @__PURE__ */ ((ProtoDealStatus2) => {
  ProtoDealStatus2[ProtoDealStatus2["FILLED"] = 2] = "FILLED";
  ProtoDealStatus2[ProtoDealStatus2["PARTIALLY_FILLED"] = 3] = "PARTIALLY_FILLED";
  ProtoDealStatus2[ProtoDealStatus2["REJECTED"] = 4] = "REJECTED";
  ProtoDealStatus2[ProtoDealStatus2["INTERNALLY_REJECTED"] = 5] = "INTERNALLY_REJECTED";
  ProtoDealStatus2[ProtoDealStatus2["ERROR"] = 6] = "ERROR";
  ProtoDealStatus2[ProtoDealStatus2["MISSED"] = 7] = "MISSED";
  return ProtoDealStatus2;
})(ProtoDealStatus || {});
var ProtoDealType = /* @__PURE__ */ ((ProtoDealType2) => {
  ProtoDealType2[ProtoDealType2["MARKET_DEAL"] = 1] = "MARKET_DEAL";
  ProtoDealType2[ProtoDealType2["LIMIT_DEAL"] = 2] = "LIMIT_DEAL";
  return ProtoDealType2;
})(ProtoDealType || {});
var ProtoTradeSide = /* @__PURE__ */ ((ProtoTradeSide2) => {
  ProtoTradeSide2[ProtoTradeSide2["BUY"] = 1] = "BUY";
  ProtoTradeSide2[ProtoTradeSide2["SELL"] = 2] = "SELL";
  return ProtoTradeSide2;
})(ProtoTradeSide || {});
var ProtoBookType = /* @__PURE__ */ ((ProtoBookType2) => {
  ProtoBookType2[ProtoBookType2["BOOK_A"] = 1] = "BOOK_A";
  ProtoBookType2[ProtoBookType2["BOOK_B"] = 2] = "BOOK_B";
  return ProtoBookType2;
})(ProtoBookType || {});
var ProtoOrderTriggerMethod = /* @__PURE__ */ ((ProtoOrderTriggerMethod2) => {
  ProtoOrderTriggerMethod2[ProtoOrderTriggerMethod2["TRADE"] = 1] = "TRADE";
  ProtoOrderTriggerMethod2[ProtoOrderTriggerMethod2["OPPOSITE"] = 2] = "OPPOSITE";
  ProtoOrderTriggerMethod2[ProtoOrderTriggerMethod2["DOUBLE_TRADE"] = 3] = "DOUBLE_TRADE";
  ProtoOrderTriggerMethod2[ProtoOrderTriggerMethod2["DOUBLE_OPPOSITE"] = 4] = "DOUBLE_OPPOSITE";
  return ProtoOrderTriggerMethod2;
})(ProtoOrderTriggerMethod || {});
var ProtoExecutionType = /* @__PURE__ */ ((ProtoExecutionType2) => {
  ProtoExecutionType2[ProtoExecutionType2["ORDER_ACCEPTED"] = 2] = "ORDER_ACCEPTED";
  ProtoExecutionType2[ProtoExecutionType2["ORDER_FILLED"] = 3] = "ORDER_FILLED";
  ProtoExecutionType2[ProtoExecutionType2["ORDER_REPLACED"] = 4] = "ORDER_REPLACED";
  ProtoExecutionType2[ProtoExecutionType2["ORDER_CANCELLED"] = 5] = "ORDER_CANCELLED";
  ProtoExecutionType2[ProtoExecutionType2["ORDER_EXPIRED"] = 6] = "ORDER_EXPIRED";
  ProtoExecutionType2[ProtoExecutionType2["ORDER_REJECTED"] = 7] = "ORDER_REJECTED";
  ProtoExecutionType2[ProtoExecutionType2["ORDER_CANCEL_REJECTED"] = 8] = "ORDER_CANCEL_REJECTED";
  ProtoExecutionType2[ProtoExecutionType2["SWAP"] = 9] = "SWAP";
  ProtoExecutionType2[ProtoExecutionType2["DEPOSIT_WITHDRAW"] = 10] = "DEPOSIT_WITHDRAW";
  ProtoExecutionType2[ProtoExecutionType2["ORDER_PARTIAL_FILL"] = 11] = "ORDER_PARTIAL_FILL";
  ProtoExecutionType2[ProtoExecutionType2["BONUS_DEPOSIT_WITHDRAW"] = 12] = "BONUS_DEPOSIT_WITHDRAW";
  ProtoExecutionType2[ProtoExecutionType2["BREAK_EVEN_SET"] = 13] = "BREAK_EVEN_SET";
  ProtoExecutionType2[ProtoExecutionType2["BREAK_EVEN_UPDATED"] = 14] = "BREAK_EVEN_UPDATED";
  ProtoExecutionType2[ProtoExecutionType2["BREAK_EVEN_CLEARED"] = 15] = "BREAK_EVEN_CLEARED";
  ProtoExecutionType2[ProtoExecutionType2["BREAK_EVEN_TRIGGERED"] = 16] = "BREAK_EVEN_TRIGGERED";
  ProtoExecutionType2[ProtoExecutionType2["PROTECTION_REJECTED"] = 17] = "PROTECTION_REJECTED";
  return ProtoExecutionType2;
})(ProtoExecutionType || {});
var ProtoPositionStatus = /* @__PURE__ */ ((ProtoPositionStatus2) => {
  ProtoPositionStatus2[ProtoPositionStatus2["POSITION_STATUS_OPEN"] = 1] = "POSITION_STATUS_OPEN";
  ProtoPositionStatus2[ProtoPositionStatus2["POSITION_STATUS_CLOSED"] = 2] = "POSITION_STATUS_CLOSED";
  ProtoPositionStatus2[ProtoPositionStatus2["POSITION_STATUS_CREATED"] = 3] = "POSITION_STATUS_CREATED";
  ProtoPositionStatus2[ProtoPositionStatus2["POSITION_STATUS_ERROR"] = 4] = "POSITION_STATUS_ERROR";
  return ProtoPositionStatus2;
})(ProtoPositionStatus || {});
var ProtoOrderType = /* @__PURE__ */ ((ProtoOrderType2) => {
  ProtoOrderType2[ProtoOrderType2["MARKET"] = 1] = "MARKET";
  ProtoOrderType2[ProtoOrderType2["LIMIT"] = 2] = "LIMIT";
  ProtoOrderType2[ProtoOrderType2["STOP"] = 3] = "STOP";
  ProtoOrderType2[ProtoOrderType2["STOP_LOSS_TAKE_PROFIT"] = 4] = "STOP_LOSS_TAKE_PROFIT";
  ProtoOrderType2[ProtoOrderType2["MARKET_RANGE"] = 5] = "MARKET_RANGE";
  ProtoOrderType2[ProtoOrderType2["STOP_LIMIT"] = 6] = "STOP_LIMIT";
  return ProtoOrderType2;
})(ProtoOrderType || {});
var ProtoTimeInForce = /* @__PURE__ */ ((ProtoTimeInForce2) => {
  ProtoTimeInForce2[ProtoTimeInForce2["GOOD_TILL_DATE"] = 1] = "GOOD_TILL_DATE";
  ProtoTimeInForce2[ProtoTimeInForce2["GOOD_TILL_CANCEL"] = 2] = "GOOD_TILL_CANCEL";
  ProtoTimeInForce2[ProtoTimeInForce2["IMMEDIATE_OR_CANCEL"] = 3] = "IMMEDIATE_OR_CANCEL";
  ProtoTimeInForce2[ProtoTimeInForce2["FILL_OR_KILL"] = 4] = "FILL_OR_KILL";
  ProtoTimeInForce2[ProtoTimeInForce2["MARKET_ON_OPEN"] = 5] = "MARKET_ON_OPEN";
  return ProtoTimeInForce2;
})(ProtoTimeInForce || {});
var ProtoOrderStatus = /* @__PURE__ */ ((ProtoOrderStatus2) => {
  ProtoOrderStatus2[ProtoOrderStatus2["ORDER_STATUS_CREATED"] = 0] = "ORDER_STATUS_CREATED";
  ProtoOrderStatus2[ProtoOrderStatus2["ORDER_STATUS_ACCEPTED"] = 1] = "ORDER_STATUS_ACCEPTED";
  ProtoOrderStatus2[ProtoOrderStatus2["ORDER_STATUS_FILLED"] = 2] = "ORDER_STATUS_FILLED";
  ProtoOrderStatus2[ProtoOrderStatus2["ORDER_STATUS_REJECTED"] = 3] = "ORDER_STATUS_REJECTED";
  ProtoOrderStatus2[ProtoOrderStatus2["ORDER_STATUS_EXPIRED"] = 4] = "ORDER_STATUS_EXPIRED";
  ProtoOrderStatus2[ProtoOrderStatus2["ORDER_STATUS_CANCELLED"] = 5] = "ORDER_STATUS_CANCELLED";
  ProtoOrderStatus2[ProtoOrderStatus2["ORDER_STATUS_ERROR"] = 6] = "ORDER_STATUS_ERROR";
  ProtoOrderStatus2[ProtoOrderStatus2["ORDER_STATUS_RESERVED"] = 7] = "ORDER_STATUS_RESERVED";
  return ProtoOrderStatus2;
})(ProtoOrderStatus || {});
var ProtoChangeBalanceType = /* @__PURE__ */ ((ProtoChangeBalanceType2) => {
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT"] = 0] = "BALANCE_DEPOSIT";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW"] = 1] = "BALANCE_WITHDRAW";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_CLOSE_POSITION"] = 2] = "BALANCE_CLOSE_POSITION";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_STRATEGY_COMMISSION_INNER"] = 3] = "BALANCE_DEPOSIT_STRATEGY_COMMISSION_INNER";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_STRATEGY_COMMISSION_INNER"] = 4] = "BALANCE_WITHDRAW_STRATEGY_COMMISSION_INNER";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_IB_COMMISSIONS"] = 5] = "BALANCE_DEPOSIT_IB_COMMISSIONS";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_IB_SHARED_PERCENTAGE"] = 6] = "BALANCE_WITHDRAW_IB_SHARED_PERCENTAGE";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_IB_SHARED_PERCENTAGE_FROM_SUB_IB"] = 7] = "BALANCE_DEPOSIT_IB_SHARED_PERCENTAGE_FROM_SUB_IB";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_IB_SHARED_PERCENTAGE_FROM_BROKER"] = 8] = "BALANCE_DEPOSIT_IB_SHARED_PERCENTAGE_FROM_BROKER";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_REBATE"] = 9] = "BALANCE_DEPOSIT_REBATE";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_REBATE"] = 10] = "BALANCE_WITHDRAW_REBATE";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_STRATEGY_COMMISSION_OUTER"] = 11] = "BALANCE_DEPOSIT_STRATEGY_COMMISSION_OUTER";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_STRATEGY_COMMISSION_OUTER"] = 12] = "BALANCE_WITHDRAW_STRATEGY_COMMISSION_OUTER";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_BONUS_COMPENSATION"] = 13] = "BALANCE_WITHDRAW_BONUS_COMPENSATION";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_IB_SHARED_PERCENTAGE_TO_BROKER"] = 14] = "BALANCE_WITHDRAW_IB_SHARED_PERCENTAGE_TO_BROKER";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_DIVIDENDS"] = 15] = "BALANCE_DEPOSIT_DIVIDENDS";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_DIVIDENDS"] = 16] = "BALANCE_WITHDRAW_DIVIDENDS";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_GSL_CHARGE"] = 17] = "BALANCE_WITHDRAW_GSL_CHARGE";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_ROLLOVER"] = 18] = "BALANCE_WITHDRAW_ROLLOVER";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_NONWITHDRAWABLE_BONUS"] = 19] = "BALANCE_DEPOSIT_NONWITHDRAWABLE_BONUS";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_NONWITHDRAWABLE_BONUS"] = 20] = "BALANCE_WITHDRAW_NONWITHDRAWABLE_BONUS";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_SWAP"] = 21] = "BALANCE_DEPOSIT_SWAP";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_SWAP"] = 22] = "BALANCE_WITHDRAW_SWAP";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_INVESTMENT_TO_STRATEGY"] = 23] = "BALANCE_WITHDRAW_INVESTMENT_TO_STRATEGY";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_FROM_INVESTOR"] = 24] = "BALANCE_DEPOSIT_FROM_INVESTOR";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_RETURNED_INVESTMENT"] = 25] = "BALANCE_DEPOSIT_RETURNED_INVESTMENT";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_BY_INVESTOR"] = 26] = "BALANCE_WITHDRAW_BY_INVESTOR";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_MANAGEMENT_FEE"] = 27] = "BALANCE_DEPOSIT_MANAGEMENT_FEE";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_MANAGEMENT_FEE"] = 28] = "BALANCE_WITHDRAW_MANAGEMENT_FEE";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_PERFORMANCE_FEE"] = 29] = "BALANCE_DEPOSIT_PERFORMANCE_FEE";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_FOR_SUBACCOUNT"] = 30] = "BALANCE_WITHDRAW_FOR_SUBACCOUNT";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_TO_SUBACCOUNT"] = 31] = "BALANCE_DEPOSIT_TO_SUBACCOUNT";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_FROM_SUBACCOUNT"] = 32] = "BALANCE_WITHDRAW_FROM_SUBACCOUNT";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_FROM_SUBACCOUNT"] = 33] = "BALANCE_DEPOSIT_FROM_SUBACCOUNT";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_COPY_FEE"] = 34] = "BALANCE_WITHDRAW_COPY_FEE";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_INACTIVITY_FEE"] = 35] = "BALANCE_WITHDRAW_INACTIVITY_FEE";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_TRANSFER"] = 36] = "BALANCE_DEPOSIT_TRANSFER";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_WITHDRAW_TRANSFER"] = 37] = "BALANCE_WITHDRAW_TRANSFER";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_CONVERTED_BONUS"] = 38] = "BALANCE_DEPOSIT_CONVERTED_BONUS";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_DEPOSIT_NEGATIVE_BALANCE_PROTECTION"] = 39] = "BALANCE_DEPOSIT_NEGATIVE_BALANCE_PROTECTION";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_RESERVED_1"] = 40] = "BALANCE_RESERVED_1";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_RESERVED_2"] = 41] = "BALANCE_RESERVED_2";
  ProtoChangeBalanceType2[ProtoChangeBalanceType2["BALANCE_RESERVED_3"] = 42] = "BALANCE_RESERVED_3";
  return ProtoChangeBalanceType2;
})(ProtoChangeBalanceType || {});
var ProtoChangeBonusType = /* @__PURE__ */ ((ProtoChangeBonusType2) => {
  ProtoChangeBonusType2[ProtoChangeBonusType2["BONUS_DEPOSIT"] = 0] = "BONUS_DEPOSIT";
  ProtoChangeBonusType2[ProtoChangeBonusType2["BONUS_WITHDRAW"] = 1] = "BONUS_WITHDRAW";
  return ProtoChangeBonusType2;
})(ProtoChangeBonusType || {});
var ProtoTrendbarPeriod = /* @__PURE__ */ ((ProtoTrendbarPeriod2) => {
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["M1"] = 1] = "M1";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["M2"] = 2] = "M2";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["M3"] = 3] = "M3";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["M4"] = 4] = "M4";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["M5"] = 5] = "M5";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["M10"] = 6] = "M10";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["M15"] = 7] = "M15";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["M30"] = 8] = "M30";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["H1"] = 9] = "H1";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["H4"] = 10] = "H4";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["H12"] = 11] = "H12";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["D1"] = 12] = "D1";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["W1"] = 13] = "W1";
  ProtoTrendbarPeriod2[ProtoTrendbarPeriod2["MN1"] = 14] = "MN1";
  return ProtoTrendbarPeriod2;
})(ProtoTrendbarPeriod || {});
var ProtoTickbarPeriod = /* @__PURE__ */ ((ProtoTickbarPeriod2) => {
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T2"] = 2] = "T2";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T3"] = 3] = "T3";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T4"] = 4] = "T4";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T5"] = 5] = "T5";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T6"] = 6] = "T6";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T7"] = 7] = "T7";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T8"] = 8] = "T8";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T9"] = 9] = "T9";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T10"] = 10] = "T10";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T15"] = 15] = "T15";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T20"] = 20] = "T20";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T25"] = 25] = "T25";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T30"] = 30] = "T30";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T40"] = 40] = "T40";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T50"] = 50] = "T50";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T60"] = 60] = "T60";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T80"] = 80] = "T80";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T90"] = 90] = "T90";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T100"] = 100] = "T100";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T150"] = 150] = "T150";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T200"] = 200] = "T200";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T250"] = 250] = "T250";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T300"] = 300] = "T300";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T500"] = 500] = "T500";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T750"] = 750] = "T750";
  ProtoTickbarPeriod2[ProtoTickbarPeriod2["T1000"] = 1e3] = "T1000";
  return ProtoTickbarPeriod2;
})(ProtoTickbarPeriod || {});
var ProtoTimeframe = /* @__PURE__ */ ((ProtoTimeframe2) => {
  ProtoTimeframe2[ProtoTimeframe2["M_1"] = 1] = "M_1";
  ProtoTimeframe2[ProtoTimeframe2["M_2"] = 2] = "M_2";
  ProtoTimeframe2[ProtoTimeframe2["M_3"] = 3] = "M_3";
  ProtoTimeframe2[ProtoTimeframe2["M_4"] = 4] = "M_4";
  ProtoTimeframe2[ProtoTimeframe2["M_5"] = 5] = "M_5";
  ProtoTimeframe2[ProtoTimeframe2["M_6"] = 6] = "M_6";
  ProtoTimeframe2[ProtoTimeframe2["M_7"] = 7] = "M_7";
  ProtoTimeframe2[ProtoTimeframe2["M_8"] = 8] = "M_8";
  ProtoTimeframe2[ProtoTimeframe2["M_9"] = 9] = "M_9";
  ProtoTimeframe2[ProtoTimeframe2["M_10"] = 10] = "M_10";
  ProtoTimeframe2[ProtoTimeframe2["M_15"] = 11] = "M_15";
  ProtoTimeframe2[ProtoTimeframe2["M_20"] = 12] = "M_20";
  ProtoTimeframe2[ProtoTimeframe2["M_30"] = 13] = "M_30";
  ProtoTimeframe2[ProtoTimeframe2["M_45"] = 14] = "M_45";
  ProtoTimeframe2[ProtoTimeframe2["H_1"] = 15] = "H_1";
  ProtoTimeframe2[ProtoTimeframe2["H_2"] = 16] = "H_2";
  ProtoTimeframe2[ProtoTimeframe2["H_3"] = 17] = "H_3";
  ProtoTimeframe2[ProtoTimeframe2["H_4"] = 18] = "H_4";
  ProtoTimeframe2[ProtoTimeframe2["H_6"] = 19] = "H_6";
  ProtoTimeframe2[ProtoTimeframe2["H_8"] = 20] = "H_8";
  ProtoTimeframe2[ProtoTimeframe2["H_12"] = 21] = "H_12";
  ProtoTimeframe2[ProtoTimeframe2["D_1"] = 22] = "D_1";
  ProtoTimeframe2[ProtoTimeframe2["D_2"] = 23] = "D_2";
  ProtoTimeframe2[ProtoTimeframe2["D_3"] = 24] = "D_3";
  ProtoTimeframe2[ProtoTimeframe2["W_1"] = 25] = "W_1";
  ProtoTimeframe2[ProtoTimeframe2["MN_1"] = 26] = "MN_1";
  return ProtoTimeframe2;
})(ProtoTimeframe || {});
var ProtoTrendbarType = /* @__PURE__ */ ((ProtoTrendbarType2) => {
  ProtoTrendbarType2[ProtoTrendbarType2["REGULAR_OHLC"] = 0] = "REGULAR_OHLC";
  ProtoTrendbarType2[ProtoTrendbarType2["HEIKIN_ASHI"] = 1] = "HEIKIN_ASHI";
  return ProtoTrendbarType2;
})(ProtoTrendbarType || {});
var ProtoPublicServerPayloadType = /* @__PURE__ */ ((ProtoPublicServerPayloadType2) => {
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["ErrorRes"] = 50] = "ErrorRes";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["OrderErrorRes"] = 138] = "OrderErrorRes";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetAccountInformationReq"] = 175] = "GetAccountInformationReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetAccountInformationRes"] = 124] = "GetAccountInformationRes";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetAccountGroupInformationReq"] = 176] = "GetAccountGroupInformationReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetAccountGroupInformationRes"] = 125] = "GetAccountGroupInformationRes";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetLightSymbolListReq"] = 841] = "GetLightSymbolListReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetLightSymbolListRes"] = 842] = "GetLightSymbolListRes";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetSymbolReq"] = 163] = "GetSymbolReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetSymbolRes"] = 164] = "GetSymbolRes";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["SubscribeQuotesReq"] = 601] = "SubscribeQuotesReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["SubscribeQuotesRes"] = 602] = "SubscribeQuotesRes";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["UnsubscribeQuotesReq"] = 608] = "UnsubscribeQuotesReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["UnsubscribeQuotesRes"] = 609] = "UnsubscribeQuotesRes";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["QuoteEvent"] = 3] = "QuoteEvent";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetDynamicLeverageReq"] = 858] = "GetDynamicLeverageReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetDynamicLeverageRes"] = 859] = "GetDynamicLeverageRes";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetDealListReq"] = 477] = "GetDealListReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["GetDealListRes"] = 478] = "GetDealListRes";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["ExecutionEvent"] = 300] = "ExecutionEvent";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["CreateNewOrderReq"] = 143] = "CreateNewOrderReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["ModifyOrderReq"] = 145] = "ModifyOrderReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["ModifyOrderProtectionReq"] = 147] = "ModifyOrderProtectionReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["CancelOrderReq"] = 144] = "CancelOrderReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["ClosePositionReq"] = 146] = "ClosePositionReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["TrendbarReq"] = 113] = "TrendbarReq";
  ProtoPublicServerPayloadType2[ProtoPublicServerPayloadType2["TrendbarRes"] = 114] = "TrendbarRes";
  return ProtoPublicServerPayloadType2;
})(ProtoPublicServerPayloadType || {});

// api/generated/serverFunctions.ts
var import_uuid2 = require("uuid");
var import_rxjs2 = __toESM(require_cjs());
var errorRes = (payload, clientMsgId) => {
  return {
    payloadType: 50 /* ErrorRes */,
    payload,
    clientMsgId
  };
};
var getAccountInformation = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 175 /* GetAccountInformationReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
    data: JSON.stringify(message)
  }, multiple).pipe(
    (0, import_rxjs2.map)((response) => {
      return JSON.parse(response.data);
    })
  );
};
var getAccountInformationHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 175 /* GetAccountInformationReq */) {
      try {
        const data$ = handler(message.payload, metadata);
        return data$.pipe(
          (0, import_rxjs2.map)((response) => {
            return {
              data: JSON.stringify(getAccountInformationRes(response, message.clientMsgId))
            };
          }),
          (0, import_rxjs2.catchError)((error) => {
            return (0, import_rxjs2.of)({
              data: JSON.stringify(errorRes(error, message.clientMsgId))
            });
          })
        );
      } catch (error) {
    ...
    return import_rxjs2.NEVER;
  });
};
var getAccountInformationRes = (payload, clientMsgId) => {
  return {
    payloadType: 124 /* GetAccountInformationRes */,
    payload,
    clientMsgId
  };
};
var getAccountGroupInformation = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 176 /* GetAccountGroupInformationReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var getAccountGroupInformationHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 176 /* GetAccountGroupInformationReq */) {
      try {
        const data$ = handler(message.payload, metadata);
        return data$.pipe(
          (0, import_rxjs2.map)((response) => {
            return {
              data: JSON.stringify(getAccountGroupInformationRes(response, message.clientMsgId))
            };
          }),
          (0, import_rxjs2.catchError)((error) => {
            return (0, import_rxjs2.of)({
...
var getAccountGroupInformationRes = (payload, clientMsgId) => {
  return {
    payloadType: 125 /* GetAccountGroupInformationRes */,
    payload,
    clientMsgId
  };
};
var getLightSymbolList = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 841 /* GetLightSymbolListReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var getLightSymbolListHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 841 /* GetLightSymbolListReq */) {
      try {
        const data$ = handler(message.payload, metadata);
        return data$.pipe(
          (0, import_rxjs2.map)((response) => {
            return {
              data: JSON.stringify(getLightSymbolListRes(response, message.clientMsgId))
            };
          }),
          (0, import_rxjs2.catchError)((error) => {
            return (0, import_rxjs2.of)({
...
var getLightSymbolListRes = (payload, clientMsgId) => {
  return {
    payloadType: 842 /* GetLightSymbolListRes */,
    payload,
    clientMsgId
  };
};
var getSymbol = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 163 /* GetSymbolReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var getSymbolHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 163 /* GetSymbolReq */) {
      try {
        const data$ = handler(message.payload, metadata);
        return data$.pipe(
          (0, import_rxjs2.map)((response) => {
            return {
              data: JSON.stringify(getSymbolRes(response, message.clientMsgId))
            };
          }),
          (0, import_rxjs2.catchError)((error) => {
            return (0, import_rxjs2.of)({
...
var getSymbolRes = (payload, clientMsgId) => {
  return {
    payloadType: 164 /* GetSymbolRes */,
    payload,
    clientMsgId
  };
};
var subscribeQuotes = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 601 /* SubscribeQuotesReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var subscribeQuotesHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 601 /* SubscribeQuotesReq */) {
      try {
        const data$ = handler(message.payload, metadata);
        return data$.pipe(
          (0, import_rxjs2.map)((response) => {
            return {
              data: JSON.stringify(subscribeQuotesRes(response, message.clientMsgId))
            };
          }),
          (0, import_rxjs2.catchError)((error) => {
            return (0, import_rxjs2.of)({
...
var subscribeQuotesRes = (payload, clientMsgId) => {
  return {
    payloadType: 602 /* SubscribeQuotesRes */,
    payload,
    clientMsgId
  };
};
var unsubscribeQuotes = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 608 /* UnsubscribeQuotesReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var unsubscribeQuotesHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 608 /* UnsubscribeQuotesReq */) {
      try {
        const data$ = handler(message.payload, metadata);
        return data$.pipe(
          (0, import_rxjs2.map)((response) => {
            return {
              data: JSON.stringify(unsubscribeQuotesRes(response, message.clientMsgId))
            };
          }),
          (0, import_rxjs2.catchError)((error) => {
            return (0, import_rxjs2.of)({
...
var unsubscribeQuotesRes = (payload, clientMsgId) => {
  return {
    payloadType: 609 /* UnsubscribeQuotesRes */,
    payload,
    clientMsgId
  };
};
var getDynamicLeverage = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 858 /* GetDynamicLeverageReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var getDynamicLeverageHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 858 /* GetDynamicLeverageReq */) {
      try {
        const data$ = handler(message.payload, metadata);
        return data$.pipe(
          (0, import_rxjs2.map)((response) => {
            return {
              data: JSON.stringify(getDynamicLeverageRes(response, message.clientMsgId))
            };
          }),
          (0, import_rxjs2.catchError)((error) => {
            return (0, import_rxjs2.of)({
...
var getDynamicLeverageRes = (payload, clientMsgId) => {
  return {
    payloadType: 859 /* GetDynamicLeverageRes */,
    payload,
    clientMsgId
  };
};
var getDealList = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 477 /* GetDealListReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var getDealListHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 477 /* GetDealListReq */) {
      try {
        const data$ = handler(message.payload, metadata);
        return data$.pipe(
          (0, import_rxjs2.map)((response) => {
            return {
              data: JSON.stringify(getDealListRes(response, message.clientMsgId))
            };
          }),
          (0, import_rxjs2.catchError)((error) => {
            return (0, import_rxjs2.of)({
...
var getDealListRes = (payload, clientMsgId) => {
  return {
    payloadType: 478 /* GetDealListRes */,
    payload,
    clientMsgId
  };
};
var createNewOrder = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 143 /* CreateNewOrderReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var createNewOrderHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 143 /* CreateNewOrderReq */) {
      try {
        return handler(message.payload, metadata).pipe(
          (0, import_rxjs2.mergeMap)(() => import_rxjs2.EMPTY),
          (0, import_rxjs2.catchError)((error) => {
            return (0, import_rxjs2.of)({
...
var modifyOrder = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 145 /* ModifyOrderReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var modifyOrderHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 145 /* ModifyOrderReq */) {
      try {
        return handler(message.payload, metadata).pipe(
          (0, import_rxjs2.mergeMap)(() => import_rxjs2.EMPTY),
          (0, import_rxjs2.catchError)((error) => {
...
var modifyOrderProtection = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 147 /* ModifyOrderProtectionReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var modifyOrderProtectionHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 147 /* ModifyOrderProtectionReq */) {
      try {
        return handler(message.payload, metadata).pipe(
          (0, import_rxjs2.mergeMap)(() => import_rxjs2.EMPTY),
          (0, import_rxjs2.catchError)((error) => {
...
var cancelOrder = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 144 /* CancelOrderReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var cancelOrderHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 144 /* CancelOrderReq */) {
      try {
        return handler(message.payload, metadata).pipe(
          (0, import_rxjs2.mergeMap)(() => import_rxjs2.EMPTY),
          (0, import_rxjs2.catchError)((error) => {
...
var closePosition = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 146 /* ClosePositionReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var closePositionHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 146 /* ClosePositionReq */) {
      try {
        return handler(message.payload, metadata).pipe(
          (0, import_rxjs2.mergeMap)(() => import_rxjs2.EMPTY),
          (0, import_rxjs2.catchError)((error) => {
...
var getTrendbarList = (transport, payload, multiple = false) => {
  const message = {
    payloadType: 113 /* TrendbarReq */,
    payload,
    clientMsgId: (0, import_uuid2.v4)()
  };
  return getServerData(transport, {
...
var getTrendbarListHandler = (transport, handler) => {
  return getServerDataHandler(transport, (request, metadata) => {
    const message = JSON.parse(request.data);
    if (message.payloadType === 113 /* TrendbarReq */) {
      try {
        const data$ = handler(message.payload, metadata);
        return data$.pipe(
          (0, import_rxjs2.map)((response) => {
            return {
              data: JSON.stringify(getTrendbarListRes(response, message.clientMsgId))
            };
          }),
          (0, import_rxjs2.catchError)((error) => {
            return (0, import_rxjs2.of)({
...
var getTrendbarListRes = (payload, clientMsgId) => {
  return {
    payloadType: 114 /* TrendbarRes */,
    payload,
    clientMsgId
  };
};
var quoteEvent = (transport) => {
  return serverDataEvent(transport).pipe(
    (0, import_rxjs2.map)((event) => {
      return JSON.parse(event.data);
    }),
    (0, import_rxjs2.filter)((message) => message.payloadType === 3 /* QuoteEvent */),
    (0, import_rxjs2.map)((event) => {
      return event.payload;
    })
  );
};
var handleQuoteEvent = (transport, payload) => {
  return handleServerDataEvent(transport, {
    data: JSON.stringify(quoteEventData(payload, (0, import_uuid2.v4)()))
  });
};
var quoteEventData = (payload, clientMsgId) => {
  return {
    payloadType: 3 /* QuoteEvent */,
    payload,
    clientMsgId
  };
};
var executionEvent = (transport) => {
  return serverDataEvent(transport).pipe(
    (0, import_rxjs2.map)((event) => {
      return JSON.parse(event.data);
    }),
    (0, import_rxjs2.filter)((message) => message.payloadType === 300 /* ExecutionEvent */),
    (0, import_rxjs2.map)((event) => {
      return event.payload;
    })
  );
};
var handleExecutionEvent = (transport, payload) => {
  return handleServerDataEvent(transport, {
    data: JSON.stringify(executionEventData(payload, (0, import_uuid2.v4)()))
  });
};
var executionEventData = (payload, clientMsgId) => {
  return {
    payloadType: 300 /* ExecutionEvent */,
    payload,
    clientMsgId
  };
};

// api/tradingFunctions.ts
var import_rxjs3 = __toESM(require_cjs());
var isExecutionEvent = (event) => {
  return "executionType" in event;
};
var createNewOrder2 = (transport, payload) => {
  return (0, import_rxjs3.merge)(
    createNewOrder(transport, payload),
    executionEvent(transport)
  ).pipe(
    (0, import_rxjs3.takeWhile)((event) => {
      if (isExecutionEvent(event)) {
        return event.executionType !== 3 /* ORDER_FILLED */ && event.executionType !== 5 /* ORDER_CANCELLED */ && event.executionType !== 7 /* ORDER_REJECTED */;
      }
      return true;
    }, true)
  );
};
var modifyOrder2 = (transport, payload) => {
  return (0, import_rxjs3.merge)(
    modifyOrder(transport, payload),
    executionEvent(transport)
  ).pipe(
    (0, import_rxjs3.takeWhile)((event) => {
      if (isExecutionEvent(event)) {
        return event.executionType !== 4 /* ORDER_REPLACED */;
      }
      return true;
    }, true)
  );
};
var modifyOrderProtection2 = (transport, payload) => {
  return (0, import_rxjs3.merge)(
    modifyOrderProtection(transport, payload),
    executionEvent(transport)
  ).pipe(
    (0, import_rxjs3.takeWhile)((event) => {
      if (isExecutionEvent(event)) {
        return event.executionType !== 2 /* ORDER_ACCEPTED */ && event.executionType !== 4 /* ORDER_REPLACED */ && event.executionType !== 5 /* ORDER_CANCELLED */;
      }
      return true;
    }, true)
  );
};
var cancelOrder2 = (transport, payload) => {
  return (0, import_rxjs3.merge)(
    cancelOrder(transport, payload),
    executionEvent(transport)
  ).pipe(
    (0, import_rxjs3.takeWhile)((event) => {
      if (isExecutionEvent(event)) {
        return event.executionType !== 5 /* ORDER_CANCELLED */;
      }
      return true;
    }, true)
  );
};
var closePosition2 = (transport, payload) => {
  return (0, import_rxjs3.merge)(
    closePosition(transport, payload),
    executionEvent(transport)
  ).pipe(
    (0, import_rxjs3.takeWhile)((event) => {
      if (isExecutionEvent(event)) {
        return event.executionType !== 3 /* ORDER_FILLED */ && event.executionType !== 5 /* ORDER_CANCELLED */;
      }
      return true;
    }, true)
  );
...
0 && (module.exports = {
  ...
  getAccountGroupInformationHandler,
  getAccountInformation,
  getAccountInformationHandler,
  getDealList,
  getDealListHandler,
  getDynamicLeverage,
  getDynamicLeverageHandler,
  getLightSymbolList,
  getLightSymbolListHandler,
  getServerData,
  getServerDataHandler,
  getSymbol,
  getSymbolHandler,
  getTrendbarList,
  getTrendbarListHandler,
  handleConfirmEvent,
  handleExecutionEvent,
  handleQuoteEvent,
  handleRegisterEvent,
  handleServerDataEvent,
  modifyOrder,
  modifyOrderHandler,
  modifyOrderProtection,
  modifyOrderProtectionHandler,
  openInternalUrl,
  openInternalUrlHandler,
  quoteEvent,
  registerEvent,
  serverDataEvent,
  subscribeQuotes,
  subscribeQuotesHandler,
  unsubscribeQuotes,
  unsubscribeQuotesHandler
});
